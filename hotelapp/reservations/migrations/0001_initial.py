    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_content', models.CharField(db_column='text', max_length=40)),
                ('cid', models.ForeignKey(db_column='cid', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('rr_id', models.ForeignKey(db_column='rr_id', on_delete=django.db.models.deletion.CASCADE, to='reservations.roomreservation')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='rr_id',
            field=models.ForeignKey(db_column='rr_id', on_delete=django.db.models.deletion.CASCADE, to='reservations.roomreservation'),
        ),
        migrations.AddField(
            model_name='reservationservice',
            name='sid',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('cid', 'rr_id'), name='unique roomreview'),
        ),
        migrations.AddConstraint(
